...
public class GuessGame {
    ...
    public GuessGame(GuessTab gt) {
        ...
        if (this.counter < 4) {
            ...
            //guessField.setText("");
            guessTab.setGuessFieldText("please enter an positive number between 1 and 100 inclusive: ", "");
            this.counter++;

            if (guess < 1 || guess > 100) {
                //guessField.setPromptText("Invalid input");
                //guessField.setText("");
                guessTab.setGuessFieldText("Invalid Input", "");
                this.counter--;
                ...
                guessTab.setGuessFieldText("Congratulations you won! Your number of tries was: " + counter, "");
