...
public class GuessTab extends Tab implements EventHandler {
    ...
    public static TextArea getGuessField() {
        return guessField;
    }

    public static void setGuessFieldText(String promptMessage, String message) {
        //GuessTab.guessField = guessField;
        guessField.setPromptText(promptMessage);
